...
class ImageProcessor:
    ...
    def base64_to_image(base64_string: str):
        try:
            ...
            raise ValueError(f"Error in base64_to_image: {str(e)}")
    ...
    def save_image_local(image_data: any, save_path: str, file_name: str, extension: str):
        try:
            ...
            # If `image_data` is a file path
                ...
                raise ValueError("Error in save_image_local: Unsupported image_data type")
        except Exception as e:
            raise ValueError(f"Error in save_image_local: {str(e)}")
