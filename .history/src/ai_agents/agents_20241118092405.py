...
class AI_Agents:
    ...
    @staticmethod
    def intent_detection(query: str, content_type: str = "Research"):
    ...
    @staticmethod
    def chatbot_response(query: str, chat_history: list, content_type: str = "Research"):
        ...
        if content_type == "Research":
            ...
            if intent_detection.lower().strip() == "true":
                ...
                print(query)
            chat_history = AI_Agents.prepeare_chat_history(chat_history)
            print(chat_history)
            # system_prompt, input_prompt = AI_Agents.get_the_prompts(content_type, main_prompt_info)
            # chat_history_str = "\n".join(chat_history)
